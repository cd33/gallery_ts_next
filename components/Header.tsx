    ...
    <Box>
      ...
      >
        ...
        <Flex flex={{ base: 1 }} justify={{ base: "center", md: "start" }}>
          ...
          <ChakraNextLink href="/">
            <ChakraNextImage src="/logo.png" alt="Logo" placeholder="blur" layout="responsive" width={20} height={30} />
          </ChakraNextLink>
...
const DesktopNav = () => {
  ...
  const linkHoverColor: string = "#b2b2b2";
  const popoverContentBgColor: string = "black";
          ...
          <Popover trigger={"hover"} placement={"bottom-start"}>
            <PopoverTrigger>
              <ChakraNextLink
                ...
                fontSize="xl"
                fontWeight={700}
                color={router.pathname === navItem.href ? 'orange' : 'white'}
                _hover={{
                  textDecoration: "none",
